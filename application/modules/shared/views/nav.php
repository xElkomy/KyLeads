<nav class="mainnav navbar navbar-inverse navbar-embossed navbar-fixed-top" role="navigation" id="mainNav">
	...
	<div class="collapse navbar-collapse" id="navbar-collapse-01">
		<ul class="nav navbar-nav">
			...
			<?php else: ?>
				<li <?php if (isset($page) && $page == "dashboard") : ?>class="active"<?php endif; ?>><a href="dashboard"><span class="fa fa-tachometer"></span> <?php echo $this->lang->line('nav_dashboard'); ?></a></li>
				...
				<?php if ($this->session->userdata('user_type') == 'Admin') : ?>
					...
					<li <?php if (isset($page) && $page == "forms") : ?>class="active"<?php endif; ?>><a href="forms"><span class="fa fa-yelp"></span> <?php echo $this->lang->line('nav_forms'); ?></a></li>
					<li <?php if (isset($page) && $page == "quiz") : ?>class="active"<?php endif; ?>><a href="quiz"><span class="fa fa-question-circle"></span> <?php echo $this->lang->line('nav_quiz'); ?></a></li>
					<li <?php if (isset($page) && $page == "site") : ?>class="active"<?php endif; ?>><a href="sites"><span class="fui-windows"></span> <?php echo $this->lang->line('nav_sites'); ?></a></li>
				<?php endif; ?>
