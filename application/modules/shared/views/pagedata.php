<form class="form-horizontal" role="form" id="pageSettingsForm" action="sites/updatePageData">
	...
	<div class="optionPane">
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				<textarea class="form-control" id="pageData_headerCss" name="pageData_headerCss" rows="7" placeholder="CSS applied specifically to this page"><?php if (isset($pagesData['index'])) { echo $pagesData['index']->pages_css; } ?></textarea>
			</div>
		</div>
