          ...
          <div class="container ">
                ...
                <h6> Question : </h6>
                    <?php echo $question->title;?>
                                        ...
                                        <table style="width:100%">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><a href="<?php echo base_url('quiz/delete_choice_template/'. $choice->id); ?>" type ="submit" class="btn btn-danger">Delete</a></td>
                                                </tr>
                                            <?php
                                            }
                                            ?>
                        ...
                        <a  href="<?php echo base_url('quiz/configure_template/'. $question->quiz_id); ?>" type ="submit" class="btn btn-success">Done</a> 
                    </div>
                </div>
            </div>
          </div>
