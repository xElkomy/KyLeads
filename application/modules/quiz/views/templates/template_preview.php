...
<body>
    ...
    <div class="container-fluid">
     	    ...
     	    <!---->
     	    <div class="col-sm-10">
                 <div class="text-center"><h3><?php echo $quizzes[0]->title?></h3> <hr></div>
                 <div class="text-center"><h6><?php echo $quizzes[0]->description?></h6> <hr></div>
                 
                 <?php
                    ?>
                        <div class="tab">
                            <?php
                                foreach ($quizzes[0]->questions as $key => $question) {
                                    ?>     
