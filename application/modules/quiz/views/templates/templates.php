                              ...
                              <tr class="table-borderless">
                                ...
                                ?>
                                    ...
                                    <button type="button" class="btn btn-primary n-q" >
                                        ...
                                        <a href="<?php echo base_url('quiz/preview_template/'. $quiz->id); ?>" type ="submit" class="btn btn-info btn-m-s-u btn-r-u"><i class="fa fa-eye" aria-hidden="true"></i></a>                                            
                                        <a  href="<?php echo base_url('quiz/newquiz_temp/'. $quiz->id); ?>" type ="submit" class="btn btn-success btn-m-s-u btn-r-u"><i class="fa fa-share-square-o" aria-hidden="true"></i></a><br>
                                        
                                        <?php if($this->session->userdata('user_type') === "Admin"){
                                            ?>
                                            <a  href="<?php echo base_url('quiz/configure_template/'. $quiz->id); ?>" type ="submit" class="btn btn-warning btn-m-s-u btn-r-u"><i class="fa fa-wrench" aria-hidden="true"></i></a>
                                            <a  href="<?php echo base_url('quiz/delete_quiz_template/'. $quiz->id); ?>" type ="submit" class="btn btn-danger  btn-m-s-u btn-r-u"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                            <?php
                                        }
                                        ?>
