                                ...
                                <table style="width:100%">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                            <a href="<?php echo base_url('quiz/update_template_answers/'. $question->id); ?>" type ="submit" class="btn btn-primary">Update Answers</a>
                                            <a href="<?php echo base_url('quiz/delete_question_template/'. $question->id); ?>" type ="submit" class="btn btn-danger">Delete</a> 
                                            </td>
                                        </tr>
                                    <?php
                                    }
                                        ...
                                        <h6> Add Question here</h6>
                                            <div class="panel panel-default">
                                                <div class="panel-body">
                                                    <form action="<?php echo base_url('quiz/newtemplatequestion'); ?>" method="post">
