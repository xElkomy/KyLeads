                        ...
                        <div id="new-optin" class="tabcontent">
                            ...
                            <tbody>
                                    ...
                                    <tr class="table-borderless"> 
                                        <td class="f-d-td btn-r-u">
                                            <button type="button" class="btn btn-primary n-q-d btn-r-u">
                                                <?php echo $quiz->title;?><br><?php echo $quiz->description;?>
                                            </button>
                                            <a href="<?php echo base_url('quiz/delete_quiz/'. $quiz->id); ?>" class="btn btn-primary">Remove</a></td>
                                        </td>
