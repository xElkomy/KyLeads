    	...
    	<div class="row">
    		...
    		<div class="col-md-4 col-md-offset-4">
    			...
    			<h2 class="text-center">
                    <?php echo $this->lang->line('payment_card_update_heading'); ?>
                </h2>
                ...
                <form role="form" action="auth/payment_card_update" method="post">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="card_number" name="card_number" placeholder="<?php echo $this->lang->line('payment_card_update_input_card_number_placeholder'); ?>" value="">
                    </div>

                    <div class="input-group" style="width:100%">
                        <select name="card_month" id="card_month" class="form-control select select-block mbl">
                            <option value="" selected=""><?php echo $this->lang->line('payment_card_update_select_card_month_placeholder')?></option>
                            <?php
                            for ($i=1; $i < 13; $i++ )
                            {
                                ?>
                    ...
                    <div class="input-group" style="width:100%">
                        <select name="card_year" id="card_year" class="form-control select select-block mbl">
                            <option value="" selected=""><?php echo $this->lang->line('payment_card_update_select_card_year_placeholder'); ?></option>
                            <?php
                            $year = date('Y');
                            $till = $year + 10;
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="card_cvc" name="card_cvc" placeholder="<?php echo $this->lang->line('payment_card_update_input_card_cvc_placeholder'); ?>" value="">
                    </div>
                    ...
                    <button type="submit" class="btn btn-primary btn-block btn-embossed"><?php echo $this->lang->line('payment_card_update_button'); ?></span></button>

                    <hr class="dashed light">

                    <div class="text-center">
                        <a href="auth" style="font-size: 15px"><span class="fui-arrow-left"></span> <?php echo $this->lang->line('payment_card_update_backlink'); ?></a>
                    </div>
